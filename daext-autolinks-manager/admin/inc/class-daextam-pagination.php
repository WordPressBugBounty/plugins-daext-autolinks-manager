...
class Daextam_Pagination {
	 ...
	 * Constructor.
	 *
	 * @param Daextam_Shared $shared Instance of the shared class.
	 */
	...
	public function show() {
		...
		if ( $last_page > 1 ) {
			...
			echo '<div class="daextam-crud-table-controls__pagination-paging-text">' .
				esc_html( $this->current_page ) .
				'&nbsp' .
				esc_html__( 'of', 'daext-autolinks-manager' ) .
				'&nbsp' .
				esc_html( $last_page ) .
				'</div>';
