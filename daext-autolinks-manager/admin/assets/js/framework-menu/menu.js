	...
	function ($) {
		...
		$( document.body ).on(
			...
			function () {
				...
				$( '.daextam-main-form__daext-form-section-body[data-section-id="' + target + '"]' ).toggleClass( 'daextam-main-form__daext-form-section-body-opened' );
		...
		$( document.body ).on(
			'mouseenter',
			'.daextam-admin-toolbar__menu-item-more',
			function () {
				$( '.daextam-admin-toolbar__pop-sub-menu' ).show();
			}
		);

		$( document.body ).on(
			'mouseleave',
			'.daextam-admin-toolbar__menu-item-more, .daextam-admin-toolbar__pop-sub-menu',
			function () {
				$( '.daextam-admin-toolbar__pop-sub-menu' ).hide();
			}
		);
		...
		$( document ).on(
			'change',
			'.daextam-bulk-action-checkbox',
			function () {
				let selectedItems = [];
				$( '.daextam-bulk-action-checkbox:checked' ).each(
					function () {
